...
interface IGraph<V> {//made public to work with Driver Application
     ...
     * @throws java.util.NoSuchElementException if the vertex is not present in the graph
     */
     ...
     * @throws java.util.NoSuchElementException if the origin vertex is not present in this graph
     */
